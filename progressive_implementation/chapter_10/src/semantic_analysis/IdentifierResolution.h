...
public:
    ...
    std::shared_ptr<AST::VariableDeclaration> resolveLocalVarDeclaration(const std::shared_ptr<AST::VariableDeclaration> &decl, IdMap &idMap);
    ...
    std::shared_ptr<AST::VariableDeclaration> resolveGlobalScopeVariableDeclaration(const std::shared_ptr<AST::VariableDeclaration> &varDecl, IdMap &idMap);
    ...
    std::shared_ptr<AST::Declaration> resolveGlobalDeclaration(const std::shared_ptr<AST::Declaration> &decl, IdMap &idMap);
